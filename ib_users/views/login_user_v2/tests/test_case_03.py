...
class TestCase03LoginUserV2APITestCase(CustomAPITestCase):
    def __init__(self, *args, **kwargs):
        super(TestCase03LoginUserV2APITestCase, self).__init__(APP_NAME, OPERATION_NAME, REQUEST_METHOD, URL_SUFFIX,
                                                               test_case,
                                                               *args, **kwargs)
    ...
    def test_case(self):
        ...
        response = super(TestCase03LoginUserV2APITestCase, self).test_case()
