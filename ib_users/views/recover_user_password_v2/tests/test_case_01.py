...
class TestCase01RecoverUserPasswordV2APITestCase(CustomAPITestCase):
    def __init__(self, *args, **kwargs):
        super(TestCase01RecoverUserPasswordV2APITestCase, self).__init__(APP_NAME, OPERATION_NAME, REQUEST_METHOD,
    ...
    def test_case(self):
        ...
        response = super(TestCase01RecoverUserPasswordV2APITestCase, self).test_case()
