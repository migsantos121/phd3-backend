...
class TestCase01TwitterRequestAPITestCase(CustomAPITestCase):
    def __init__(self, *args, **kwargs):
        from . import APP_NAME, OPERATION_NAME, REQUEST_METHOD, URL_SUFFIX
        super(TestCase01TwitterRequestAPITestCase, self). \
            __init__(APP_NAME, OPERATION_NAME, REQUEST_METHOD, URL_SUFFIX, 
                     TEST_CASE, *args, **kwargs)

    def test_case(self):
        response = super(TestCase01TwitterRequestAPITestCase, self).test_case()
