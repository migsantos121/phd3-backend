...
response_body = """
{"res_status": "", "response": "Application not found", "http_status_code": 404}
"""
...
class TestCase02UserLoginV2VerifyOtpAPITestCase(CustomAPITestCase):
    def __init__(self, *args, **kwargs):
        super(TestCase02UserLoginV2VerifyOtpAPITestCase, self).__init__(APP_NAME, OPERATION_NAME, REQUEST_METHOD,
    ...
    def test_case(self):
        ...
        Application.objects.create(user=user, client_id="client_id", client_secret="client")

        response = super(TestCase02UserLoginV2VerifyOtpAPITestCase, self).test_case()
