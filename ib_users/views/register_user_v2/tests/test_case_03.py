...
request_body = """
{
    ...
    "username": "email_phone_user", 
    "pic_thumbnail": "", 
    "gender": "M", 
    "pic": "", 
    "dob": "2012-02-02 12:21", 
    "reg_type": "email_and_phone_number", 
    "country_code": "+91", 
    "password": "user1234", 
    "email": "user@email.in",
...
response_body = """
{"username": "email_phone_user", "user_id": 1}
"""
...
class TestCase03RegisterUserV2APITestCase(CustomAPITestCase):
    def __init__(self, *args, **kwargs):
        super(TestCase03RegisterUserV2APITestCase, self).__init__(APP_NAME, OPERATION_NAME, REQUEST_METHOD, URL_SUFFIX,
                                                                  test_case,
                                                                  *args, **kwargs)

    @mock.patch("ib_users.models.user_otp.UserOTP", UserOTP)
    def test_case(self):
        response = super(TestCase03RegisterUserV2APITestCase, self).test_case()
