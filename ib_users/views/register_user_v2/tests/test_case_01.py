...
class TestCase01RegisterUserV2APITestCase(CustomAPITestCase):
    def __init__(self, *args, **kwargs):
        super(TestCase01RegisterUserV2APITestCase, self).__init__(APP_NAME, OPERATION_NAME, REQUEST_METHOD, URL_SUFFIX,
                                                                  test_case,
                                                                  *args, **kwargs)

    @mock.patch("ib_users.models.user_otp.UserOTP", UserOTP)
    def test_case(self):
        response = super(TestCase01RegisterUserV2APITestCase, self).test_case()
