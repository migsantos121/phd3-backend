...
class TestCase01UserLoginV2WithOtpAPITestCase(CustomAPITestCase):
    def __init__(self, *args, **kwargs):
        super(TestCase01UserLoginV2WithOtpAPITestCase, self).__init__(APP_NAME, OPERATION_NAME, REQUEST_METHOD, URL_SUFFIX, test_case,
                                                  *args, **kwargs)
    ...
    def test_case(self):
        ...
        response = super(TestCase01UserLoginV2WithOtpAPITestCase, self).test_case()
