...
class TestCase01VerifyDataUpdateV2APITestCase(CustomAPITestCase):
    def __init__(self, *args, **kwargs):
        super(TestCase01VerifyDataUpdateV2APITestCase, self).__init__(APP_NAME, OPERATION_NAME, REQUEST_METHOD,
    ...
    def test_case(self):
        ...
        response = super(TestCase01VerifyDataUpdateV2APITestCase, self).test_case()
        # your extended implementation of test case
        self.assertEqual(response.status_code, 200)

    def setupUser(self, username, password):
        super(TestCase01VerifyDataUpdateV2APITestCase, self).setupUser(username, password)

        self.foo_user.first_name = "user"
        self.foo_user.id = 1

    def setupOAuth(self, scopes):
        super(TestCase01VerifyDataUpdateV2APITestCase, self).setupOAuth(scopes)
