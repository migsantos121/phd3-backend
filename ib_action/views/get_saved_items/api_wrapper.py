...
def api_wrapper(*args,**kwargs):
    ...
    from ib_action.views.get_saved_items.tests.test_case_01 import test_case
    from django_swagger_utils.drf_server.utils.server_gen.mock_response import mock_response
    response_tuple = mock_response(app_name="ib_action", operation_name="get_saved_items", test_case=test_case,
                                       kwargs=kwargs)
