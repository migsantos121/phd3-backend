...
class TestCase02AddActionAPITestCase(CustomAPITestCase):
    def __init__(self, *args, **kwargs):
        super(TestCase02AddActionAPITestCase, self).__init__(APP_NAME, OPERATION_NAME, REQUEST_METHOD, URL_SUFFIX, test_case,
                                                  *args, **kwargs)

    def test_case(self):
        response = super(TestCase02AddActionAPITestCase, self).test_case()

    def setupUser(self, username, password):
        super(TestCase02AddActionAPITestCase, self).setupUser(username, password)
