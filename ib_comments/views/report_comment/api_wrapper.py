...
def api_wrapper(*args,**kwargs):
    ...
    from ib_comments.views.report_comment.tests.test_case_01 import test_case
    from django_swagger_utils.drf_server.utils.server_gen.mock_response import mock_response
    response_tuple = mock_response(app_name="ib_comments", operation_name="report_comment", test_case=test_case,
                                       kwargs=kwargs)
