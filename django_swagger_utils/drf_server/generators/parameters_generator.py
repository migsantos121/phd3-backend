...
class ParametersGenerator(object):
    ...
    def parameter_file_contents(parameter_context):
        ...
        from django_swagger_utils.drf_server.templates.parameters import PARAMETER
        parameter_template = Template(PARAMETER)
        context = Context(parameter_context)
        return parameter_template.render(context)
