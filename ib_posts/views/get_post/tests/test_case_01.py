...
class TestCase01GetPostAPITestCase(CustomAPITestCase):
    def __init__(self, *args, **kwargs):
        super(TestCase01GetPostAPITestCase, self).__init__(APP_NAME, OPERATION_NAME, REQUEST_METHOD, URL_SUFFIX, test_case,
                                                  *args, **kwargs)
    ...
    def test_case(self):
        ...
        response = super(TestCase01GetPostAPITestCase, self).test_case()
        # your extended implementation of test case
        self.assertEqual(response.status_code, 200)


    def setupUser(self, username, password):
        super(TestCase01GetPostAPITestCase, self).setupUser(username, password)
