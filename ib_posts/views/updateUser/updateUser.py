def updateUser(*args, **kwargs):
    ...
    from ib_posts.views.updateUser.tests.test_case_01 import test_case
    from django_swagger_utils.drf_server.utils.server_gen.mock_response import mock_response
    response_tuple = mock_response(app_name="ib_posts", operation_name="updateUser", test_case=test_case,
                                   kwargs=kwargs)
