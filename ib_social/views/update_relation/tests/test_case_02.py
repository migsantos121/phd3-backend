...
class TestCase02UpdateRelationAPITestCase(CustomAPITestCase):
    def __init__(self, *args, **kwargs):
        super(TestCase02UpdateRelationAPITestCase, self).__init__(APP_NAME, OPERATION_NAME, REQUEST_METHOD, URL_SUFFIX,
                                                                  test_case,
                                                                  *args, **kwargs)

    def test_case(self):
        response = super(TestCase02UpdateRelationAPITestCase, self).test_case()
