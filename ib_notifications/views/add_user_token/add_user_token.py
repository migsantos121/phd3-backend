...
def add_user_token(*args, **kwargs):
    """
    ...
    user = kwargs['user']
    from ib_notifications.views.add_user_token.utils.add_or_update_user_cm_token import add_or_update_user_cm_token
    response_object = add_or_update_user_cm_token(request_data=request_data, user=user)
    from django_swagger_utils.drf_server.utils.server_gen.endpoint_response import endpoint_response
