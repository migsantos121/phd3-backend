...
def send_notification(*args, **kwargs):
    ...
    user = kwargs["user"]
    from ib_notifications.views.send_notification.utils.send_notification_response import send_notification_response
    response_object = send_notification_response(request_data, user)
    from django_swagger_utils.drf_server.utils.server_gen.endpoint_response import endpoint_response
